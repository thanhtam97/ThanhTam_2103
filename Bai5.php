...
<html>
    <head>
        ...
        <link rel="stylesheet" href="public/images/hinhnen.jpg"/>
    </head>
    <body >
        <?php
        $products = array(
        ...
        foreach ($products as $value) {
            ...
            echo '<img src="public/images/' . $value['image'] . '">';
            echo '<h1><a>' . $value['name'] . '</a></h1>';
            echo '<b>Giá: </b> <span class="gia">' . $value['price'] . '</span><br>';
            echo '<p>' . substr($value['desc'], 0, 60) . '<a href="' . $value['id'] . '.php">[...]</a></p>';
            echo '</div>';
        }
        ?>	
    </body>
